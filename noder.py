...
headline = Label(root, text=username)  # the name of the user on top of the screen.
headline.pack()
cv.pack()
print("into guess mode 1")
score_headline = Label(root, text='score: ' + str(score), font=('bubble', 15),  # the score
                       bg='white', fg="black", relief="solid")
score_headline.place(x=10, y=50)
print("into guess mode 2")
strikes_headline = Label(root, text='strikes: ' + str(strikes), font=('bubble', 15),
                         bg='white', fg="black", relief="solid")  # the strikes the user have left.
strikes_headline.place(x=10, y=20)
print("into guess mode 3")
guess = Entry(root, relief='solid', font=('bubble', 10), bg='white', fg="black")
guess.delete(0, END)
guess.insert(0, 'enter a guess')
guess.place(x=100, y=400)
print("into guess mode 4")
submit_button = Button(root, text="submit", relief="solid",
